...
class CustomPizza {
    ...
    public CustomPizza(StringBuilder toppings, double price) {
    ...
    public String toString() {
        return "CustomPizza with toppings: " + toppings + ", Price: " + price;
    }
}
    ...
    public void takeOrder() {
        ...
        do {
            ...
            if (choice > 0 && choice < 6) {
                ...
                CustomPizza customPizza = new CustomPizza(customPizzaToppings, customPizzaPrice);
